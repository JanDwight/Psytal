          ...
          <tbody >{filteredData
            .filter(subject => 
              ...
              (!selectedSection || subject.class_section === selectedSection)
                ...
                <td className="text-center p-2" style={{ width: "5%" }} onClick={() => this.handleOpenPopUp(subject)}>{subject.class_year}</td>
                <td className="text-center p-2" style={{ width: "5%" }} onClick={() => this.handleOpenPopUp(subject)}>{subject.class_section}</td>
