...
export default function ArchiveLinks({onClose, selected}) {
    ...
    const onSubmitarchivelink = async () => { 
        try {
            ...
            <div className="w-full px-4 mx-auto">
                ...
                <h className='font-bold text-3xl text-[#525252] flex items-center justify-center pb-5'>Delete Link?</h>
                    ...
                    <div className="text-center flex justify-end my-2">
                        ...
                        <button onClick={() => setShowWarning(true)} type="submit" className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 mr-6 w-full rounded-full">
                            Yes
                        </button>
                        {/**NO */}
        ...
        >
            <div>
                <ArchiveWarning
                    ...
                    handleSave={onSubmitarchivelink}
                />
            </div>
        </ReactModal>
        {successMessage && (
