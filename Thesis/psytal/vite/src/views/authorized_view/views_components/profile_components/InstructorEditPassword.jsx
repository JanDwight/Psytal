...
export const InstructorEditPassword = ({onCloseInstructorEditPassword, displayData, onInstructorPasswordChange}) => {
    const [instructor_password, setInstructorPassword]=useState(displayData);
    ...
    const handleSubmit =()=> {
        onInstructorPasswordChange(instructor_password);
        onclose();
    }
        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-wrap flex-col mx-2 mb-2">
                ...
                <input className="appearance-none block bg-gray-300 rounded-md w-full py-1.5 text-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"
                    ...
                    name="password"
                    value={instructor_password.password}
                    readOnly
                ...
                <input className="appearance-none block bg-gray-300 rounded-md w-full py-1.5 text-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"
                    type={isVisible ? "text" : "password"}
                    name="newpassword"
                    value={instructor_password.newpassword}
                    onChange={handleInstructorPasswordChange}
            ...
            <div className='mt-5 flex felx-row-2 justify-center'>
                ...
                <button onClick={onCloseInstructorEditPassword}
