...
export const InstructorEditDisplayName = ({onCloseEditInstructorDisplayName, displayData, onInstructorDisplaynameChange}) => {
    const [instructor_displayname, setInstructorDisplayname] = useState(displayData);
    ...
    const handleSubmit = (event) => {
        onInstructorDisplaynameChange(instructor_displayname); // Update the profile data in the backend
        onClose();
      };
        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-wrap flex-col mx-2 mb-2">
                ...
                <input className="appearance-none block bg-gray-300 rounded-md w-full py-1.5 text-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"
                    type="text"
                    name="displayname"
                    value={instructor_displayname.displayname}
                    readOnly
                ...
                <input className="appearance-none block bg-gray-300 rounded-md w-full py-1.5 text-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"
                    type="text"
                    name="newdisplayname"
                    value={instructor_displayname.newdisplayname}
            ...
            <div className='mt-5 flex felx-row-2 justify-center'>
                ...
                <button onClick={onCloseEditInstructorDisplayName} 
